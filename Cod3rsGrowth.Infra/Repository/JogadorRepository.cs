...
namespace Cod3rsGrowth.Infra.Repository
{
    public class JogadorRepository : IJogadorRepository
    {
        ...
        {
            using (var contextoJogador = new ConexaoDados())
            {
                if (filtro == null) return contextoJogador.TabelaJogadores.ToList();

                IQueryable<Jogador> query = contextoJogador.TabelaJogadores.AsQueryable();
